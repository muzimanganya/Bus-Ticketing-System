...
<div class="setting-index">
    ...
    <p><?php echo Html::a(Yii::t('yii2mod.settings', 'New Setting'), ['create'], ['class' => 'btn btn-success pull-right']); ?></p>
    ...
    <?php echo GridView::widget([
            ...
            'columns' => [
                ...
                [
                    'attribute' => 'section',
                    'filter' => ArrayHelper::map(Setting::find()->select('section')->distinct()->all(), 'section', 'section'),
