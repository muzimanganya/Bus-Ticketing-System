...
<div class="pricing-index">
    ...
    <p class='pull-right'>
        <?= Html::a(Yii::t('app', 'Back to List'), ['list'], ['class' => 'btn btn-primary']) ?>
    </p>
    <?= GridView::widget([
            ...
            [
				...
				'buttons' => [
					'vprint' => function ($url, $model, $key) {
						return Html::a('<button class="btn btn-success">Change Price</button>',['price', 'start'=>$model->start,'end'=>$model->end,'route'=>$model->route,'currency'=>$model->currency]
						,
						[
							'class'=>'user-route'
						]);
