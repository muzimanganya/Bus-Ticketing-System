...
<div id="login"> 
    ...
    <h2><span class="fontawesome-lock"></span>Mobile Portal Sign In</h2>
    ...
    <?php $form = ActiveForm::begin([
        ...
        <fieldset>
            <p><?= $form->field($model, 'username')->textInput(['autofocus' => true, 'id'=>'email', 'placeholder'=>'Username'])->label(false) ?></p>
